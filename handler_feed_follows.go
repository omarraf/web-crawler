...
func (apiCfg *apiConfig) handlerGetFeedFollows(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	responseFeedFollows := make([]FeedFollow, len(feedFollows))
	for i, feedFollow := range feedFollows {
		responseFeedFollows[i] = databaseFeedFollowToFeedFollow(feedFollow)
	}

	respondWithJSON(w, 200, responseFeedFollows)
}
